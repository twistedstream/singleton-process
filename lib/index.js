...
function SingletonProcess(name, mongoUri) {
    var self = this;
...
util.inherits(SingletonProcess, EventEmitter);

module.exports = SingletonProcess;
...
SingletonProcess.prototype.lock = function () {
    var self = this;
...
SingletonProcess.prototype.release = function () {
    var self = this;
